...
app = Flask(__name__) #un oggetto della classe Flask, contiene tutti i codici di Flask
...
@app.route("/setcookie")
def setcookie():
    resp = serve_html("home.html") #serve_html, costruisce una risposta http
    # Impostiamo un cookie semplice
    resp.set_cookie("sessionid", "abc123", path="/") #alla risposta aggiungo i coockie
    return resp
...
# ---------------------------
@app.route("/showcookie") #qui scrivo le url
def showcookie():
...
if __name__ == "__main__":
    ...
    # 1° parametro: 0.0.0.0 => tutti gli Ip della nostra macchina
